...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250710160035_UseTriggerTypeCodeEnumForTriggerType")]
    partial class UseTriggerTypeCodeEnumForTriggerType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.DbClasses.RecipientDb", b =>
                {
                    ...
                    b.Property<string>("WebServiceRoot")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Infrastructure.DbClasses.TriggerDb", b =>
                {
                    ...
                    b.Property<int>("CommunicationModeId")
                        .HasColumnType("int");

                    b.Property<bool>("IsEnabled")
                        .HasColumnType("bit");

                    b.Property<int>("MinimumSendIntervalMinutes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RecipientDbRecipientSetDb", b =>
                {
                    b.Property<int>("RecipientSetsId")
                        .HasColumnType("int");

                    b.Property<int>("RecipientsId")
                        .HasColumnType("int");

                    b.HasKey("RecipientSetsId", "RecipientsId");
            ...
            modelBuilder.Entity("Infrastructure.DbClasses.TriggerDb", b =>
                {
                    ...
                    b.HasOne("Infrastructure.DbClasses.CommunicationModeDb", "CommunicationMode")
                        .WithMany()
                        .HasForeignKey("CommunicationModeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("CommunicationMode");
            ...
            modelBuilder.Entity("RecipientDbRecipientSetDb", b =>
                {
                    b.HasOne("Infrastructure.DbClasses.RecipientSetDb", null)
                        .WithMany()
                        .HasForeignKey("RecipientSetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Infrastructure.DbClasses.RecipientDb", null)
                        .WithMany()
